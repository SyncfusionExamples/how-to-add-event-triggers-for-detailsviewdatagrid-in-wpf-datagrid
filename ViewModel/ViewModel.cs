...
namespace DetailsViewStackedHeaderRowsDemo
{
    public class ViewModel : NotificationObject
    {
        ...
        public ViewModel()
        {
            ...
            CellTappedCommand = new CellTappedCommand();
        }
        ...
        public CellTappedCommand CellTappedCommand { get; set; }

    }

    public class CellTappedCommand : ICommand
    {
        ...
        {
            MessageBox.Show("CellTapped Command Executed");
        }
    }
}
